...
### Run on the sample CSV

```bash
python madrid.py sample_madrid_air_quality.csv
```

### Run on the full dataset folder

The full folder should contain `metraq_aq-2001.csv` through `metraq_aq-2024.csv`.
...
```powershell
python madrid.py "C:\Users\PC\Desktop\advanced coding project\METRAQ-Air-Quality"
```

Note: Task 9 may be skipped on the sample CSV because lagged forecasting requires enough continuous rows after lag construction. It is intended for the full dataset.
...
```
 sensor_name magnitude maxgaph ngaps totalmissingh
...
<table style="border-collapse:collapse;width:100%;background:#ffffff;margin:10px 0;">
 ...
 <tr>
 <td style="background:#ffffff;padding:6px 14px;border:1px solid #cccccc;text-align:left;">OCRBF_GAUSSIAN</td>
