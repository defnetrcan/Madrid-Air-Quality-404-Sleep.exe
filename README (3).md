...
magnitude_name method rmse mae
 ...
 SO2 rolling24hpast 4.236 1.999 <- best causal
 SO2 knn 5.521 3.343
```
...
NO2 rolling24hpast 0.3578 <- most different
O3 knn 0.1937
O3 rolling24hpast 0.2694
<PM10 knn 0.0706 <- most similar
<PM10 rolling24hpast 0.3336
SO2 rolling24hpast 0.3697 <- wins on RMSE but very different distribution
```
...
Max |rraw - rdetrended| across all pairs: 0.266
